...
var source = require("./codemotion.json");

var talks = new Array(source.talks.length);

var TZoffset = 2; // UTC+1 for Milan
source.talks.forEach(function (item, index) {
    ...
    event.url = "http://milan2016.codemotionworld.com/wp-content/themes/event/detail-talk.php?detail=" + item.id;
